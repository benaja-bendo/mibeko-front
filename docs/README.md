...
> Statut : à jour au 13 septembre 2026 · index de la documentation du dashboard React (`mibeko-front`).
...
| [design-system.md](./design-system.md) | Design system à jour : contrat de tokens, moteur de thèmes, thème clair « Mibeko Classique » par défaut et thème sombre optionnel « Lex Gold ». |
